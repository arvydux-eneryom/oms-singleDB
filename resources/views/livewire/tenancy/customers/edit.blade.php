...
" @input.window="formDirty = true">
    ...
    <form wire:submit="update" class="flex flex-col gap-6">
        <!-- Loading Overlay -->
        <div wire:loading.flex wire:target="update" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-50 items-center justify-center">
            <div class="bg-white rounded-lg px-8 py-6 shadow-2xl">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-lg font-semibold text-gray-900">Updating customer...</span>
                </div>
            </div>
        </div>
        ...
        <div x-show="tab === 'general'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
            <section class="max-w-4xl">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <flux:heading size="xl">Edit Customer: {{ $customer['company'] }}</flux:heading>
                </div>
